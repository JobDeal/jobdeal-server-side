...
Nova.booting(function (Vue, router) {
    Vue.component('index-map_coordinates', __webpack_require__(3));
    Vue.component('detail-map_coordinates', __webpack_require__(6));
    Vue.component('form-map_coordinates', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        if (this.field.value === null ) {
            ...
            var latLongArray = this.field.value.split(" ");
        ...
        //var myLatLng = {lat: latLongArray[0], lng: latLongArray[1]};
        var myLatLng = {lat: lat, lng: long};


        var options = {
            zoom: this.field.zoom || 4,
            //center: new google.maps.LatLng(lat || 40.730610, long || -98.935242)
            center: myLatLng
        };
        ...
        google.maps.event.addListener(map, 'click', function (event) {
            ...
            previousMarker.addListener('drag', handleEvent);
            previousMarker.addListener('dragend', handleEvent);
...
var update = __webpack_require__(20)("48e4f680", content, false, {});
